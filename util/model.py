...
class LTSMToFullyConnectedModel(nn.Module):
    """Class to represent a fully connected model strapped
    to a Long-Short-Term-Memory module as input.
    """
    ...
    def __init__(
        ...
        """Builds attributes for this model
        ...
        # Initialize torch.nn.Module
        super(LTSMToFullyConnectedModel, self).__init__()
