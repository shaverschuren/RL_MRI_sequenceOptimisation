function [F0_vector_out,Xi_F_out,Xi_Z_out] = EPG(N_in,alpha_in,SP,TR_in,T1_in,T2_in,unbalanced)
...
% - This code automatically ,RF_phase_incuses an initial alpha/2 pulse for alternating flip angles (you can change that, of course, like everything ...)
...
if RF_phase_mode == 1
    F0_vector_out = F0_vector_out .* exp(-1j * phi);
end
